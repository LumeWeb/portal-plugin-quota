...
var (
	...
	ErrInvalidIP                  = errors.New("ip cannot be empty")
	...
	ErrInvalidConsumptionDate     = errors.New("consumption_date cannot be zero")
	ErrInvalidPlanName            = errors.New("name cannot be empty")
