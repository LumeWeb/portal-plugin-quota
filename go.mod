module go.lumeweb.com/portal-plugin-quota // v0.1.0
...
require (
	...
	go.lumeweb.com/portal-plugin-dashboard v0.3.0
...
require (
	...
	go.lumeweb.com/web/go/portal-dashboard v0.0.0-20260630050642-1465adcffeab // indirect
	go.lumeweb.com/web/go/portal-plugin-core v0.0.0-20260630050642-1465adcffeab // indirect
	go.lumeweb.com/web/go/portal-plugin-dashboard v0.0.0-20260630050642-1465adcffeab // indirect
