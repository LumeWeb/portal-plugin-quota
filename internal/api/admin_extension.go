...
func (e *QuotaAdminExtension) buildRoutes() []router.Route {
	...
	return []router.Route{
		...
		e.newRoute(http.MethodGet, "/plans", e.handleListPlans,
			...
			router.WithSuccessResponse(http.StatusOK, "List of quota plans", router.WithJSONContent(&dto.PlanListResponse{}), router.WithTotalCountHeader()),
		),
		...
		e.newRoute(http.MethodGet, "/user-configs", e.handleListUserQuotaConfigs,
			...
			router.WithPaginationParams(),
			router.WithSuccessResponse(http.StatusOK, "List of user quota configs", router.WithJSONContent(&dto.UserQuotaConfigListResponse{}), router.WithTotalCountHeader()),
		),
		...
		e.newRoute(http.MethodGet, "/allowances", e.handleListAllowances,
			...
			router.WithPaginationParams(),
			router.WithSuccessResponse(http.StatusOK, "List of allowance grants", router.WithJSONContent(&dto.AllowanceListResponse{}), router.WithTotalCountHeader()),
		),
